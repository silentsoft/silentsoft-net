...
public class NoticeFileTest {
	...
	public void noticeFileTest() throws Exception {
		String markdown = generateSilentsoftNetNoticeMarkdown();
	...
	private String generateSilentsoftNetNoticeMarkdown() {
		return NoticeFileGenerator.newInstance("silentsoft-net", "silentsoft.org")
